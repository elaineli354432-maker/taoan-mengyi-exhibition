...
export function Hero() { const go = (id: string) => document.getElementById(id)?.scrollIntoView({ behavior: 'smooth' }); return <header id="top" className="hero">
  ...
  <div className="hero-art"><div className="art-stamp">陶庵<br/>旧梦</div><img src="/zhang-dai-hero.webp" decoding="async" fetchPriority="high" loading="eager" alt="雪夜西湖中的张岱水墨人物插画" /><p>一叶舟轻，万籁俱寂</p></div>
</header> }
